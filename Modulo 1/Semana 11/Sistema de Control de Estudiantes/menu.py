from actions import enter_information_4_all_students, view_student_grades, top_3_students_by_avg_grade, all_grade_avg, spanish_headers, dict_list_to_student_list
    ...
    while True:
        ...
        if option == 5:
            if student_grade_list:
                ...
                file_path = 'C:/Users/sergi/OneDrive/Documents/Lyfter/Repos/DUAD/Semana 11/Sistema de Control de Estudiantes/Data/Student_Info.csv'
                write_csv_file(file_path, data , headers)
                print(Fore.GREEN + '\nInformacion ha sido exportada con exito')
            else:
                print(Fore.RED +'\nError: Primero debe ingresar o importar la información de estudiantes') 
        if option == 6:
            file_path = 'C:/Users/sergi/OneDrive/Documents/Lyfter/Repos/DUAD/Semana 11/Sistema de Control de Estudiantes/Data/Student_Info.csv'
            try:
                student_grade_dict_list = import_csv_file(file_path)
                print(Fore.GREEN + 'Archivo de datos importado con exito')
                student_grade_list = dict_list_to_student_list(student_grade_dict_list)
            except:
